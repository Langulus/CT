...
namespace Langulus
{
   namespace Inner
   {
      ...
      consteval bool NestedSame() {
         ...
         if constexpr (::std::is_same_v<Stripped1, Stripped2>)
            return true;
   ...
   concept Akin = CT::PartialValidate<TN...>
       and (::std::is_same_v<Decay<T1>, Decay<TN>> and ...);
   ...
   concept ExactAsOneOf = CT::PartialValidate<TN...>
       and (::std::is_same_v<Deref<T1>, Deref<TN>> or ...);
}
